...
<meta property="og:url" content="http://gpawlik.com">
...
<?php endforeach;?>
<link rel="stylesheet" href="<?php echo base_url(FONTS."fontello/css/fontello.css");?>" type="text/css">
...
<body id="<?= lang('lang_code') ?>" class="home">
    <div id="fb-root"></div>
	<?php echo $body ?>
